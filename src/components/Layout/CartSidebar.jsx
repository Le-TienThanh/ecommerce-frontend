import { X, Plus, Minus, Trash2, ToggleLeft } from 'lucide-react';
                                                        ...
                                                        <div className="flex items-center space-x-2 mt-2">
                                                            <button
                                                                className={`p-1 rounded glass-card hover:glow-on-hover 
                                                                    animate-smooth ${item.quantity === 1 ? 'cursor-not-allowed' : ''}`}
                                                                onClick={() => {
                                                                    updateQuantity(
                                                                        item
                                                                            .product
                                                            ...
                                                            <button
                                                                className="p-1 rounded glass-card hover:glow-on-hover animate-smooth ml-2 
                                                            text-destructive"
                                                                onClick={() => {
                                                                    dispatch(
                                                                        removeFromCart(
