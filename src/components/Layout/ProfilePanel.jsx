                ...
                <div className="p-6">
                    ...
                    {authUser && (
                        <div className="space-y-4 mb-8">
                            ...
                            <button
                                className="flex justify-center items-center space-x-3 p-3 rounded-lg glass-card hover:text-blue-500
                    ...
                    <div className="space-y-4 mb-8">
                        ...
                        <button
                            className="flex justify-center items-center space-x-3 p-3 rounded-lg glass-card text-white hover:text-blue-500
                            hover:glow-on-hover animate-smooth group w-full"
                    ...
                    <button
                        className="my-6 flex items-center justify-center space-x-3 p-3 rounded-lg glass-card hover:glow-on-hover
                    text-red-500 hover:text-destructive-foreground group w-full"
