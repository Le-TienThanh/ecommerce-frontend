                    ...
                    {products.map((product) => {
                        return (
                            <Link
                                ...
                                className="flex-shrink-0 w-80 glass-card hover:glow-on-hover
                        animate-smooth group"
                            >
                                {/* PRODUCT IMAGE */}
                            ...
                            glass-card hover:glow-on-hover animate-smooth opacity-0 group-hover:opacity-100 transition-opacity"
